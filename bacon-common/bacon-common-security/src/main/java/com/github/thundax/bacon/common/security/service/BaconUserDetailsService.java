 ...
 *
 */
public interface BaconUserDetailsService extends UserDetailsService, Ordered {
	...
	default UserDetails getUserDetails(R<UserInfo> result) {
		...
		return new BaconUser(info.getUserId(), deptId, info.getUsername(),
	 ...
	 * @return 用户详情信息
	 */
	default UserDetails loadUserByUser(BaconUser pigUser) {
