 ...
 */
@Slf4j
public class BaconSentinelInvocationHandler implements InvocationHandler {
	...
	BaconSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			BaconSentinelInvocationHandler other = (BaconSentinelInvocationHandler) obj;
