...
package com.github.thundax.bacon.common.feign.sentinel.ext;
 ...
 *
 */
public final class BaconSentinelFeign {

	private BaconSentinelFeign() {

	}

	public static BaconSentinelFeign.Builder builder() {
		return new BaconSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public BaconSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new BaconSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new BaconSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new BaconSentinelInvocationHandler(target, dispatch);
				}
