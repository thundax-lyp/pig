package com.github.thundax.bacon.common.xss;

import com.github.thundax.bacon.common.xss.config.BaconXssProperties;
import com.github.thundax.bacon.common.xss.core.*;
...
@EnableConfigurationProperties(BaconXssProperties.class)
@ConditionalOnProperty(prefix = BaconXssProperties.PREFIX, name = "enabled", havingValue = "true",
		matchIfMissing = true)
@ConditionalOnWebApplication(type = ConditionalOnWebApplication.Type.SERVLET)
public class BaconXssAutoConfiguration implements WebMvcConfigurer {

	private final BaconXssProperties xssProperties;
	...
	public XssCleaner xssCleaner(BaconXssProperties properties) {
	 ...
	 */
	@Bean
	public FormXssClean formXssClean(BaconXssProperties properties, XssCleaner xssCleaner) {
	 ...
	 */
	@Bean
	public Jackson2ObjectMapperBuilderCustomizer xssJacksonCustomizer(BaconXssProperties properties,
