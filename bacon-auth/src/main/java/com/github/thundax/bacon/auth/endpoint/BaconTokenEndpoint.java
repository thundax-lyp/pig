...
import com.github.thundax.bacon.sys.api.vo.TokenVo;
...
import com.github.thundax.bacon.common.core.util.RedisUtils;
import com.github.thundax.bacon.common.core.util.RetOps;
...
import com.github.thundax.bacon.common.security.util.OAuth2EndpointUtils;
import com.github.thundax.bacon.common.security.util.OAuth2ErrorCodesExpand;
import com.github.thundax.bacon.common.security.util.OAuthClientException;
...
public class BaconTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new BaconAuthenticationFailureEventHandler();
	...
	public R<Boolean> removeToken(@PathVariable("token") String token) {
		...
		// 清空用户信息（立即删除）
		userDetailsCacheService.remove(authorization.getPrincipalName());
		// 清空access token
