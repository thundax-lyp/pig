...
import com.github.thundax.bacon.sys.mapper.RoleMapper;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
	...
	@Cached(name = CacheConstants.ROLE_DETAILS + ":",
			key = "@jetCacheVersionSupport.versionedKey('" + CacheConstants.ROLE_DETAILS + "', #key)", expire = 30,
	...
	public Boolean removeRoleByIds(Long[] ids) {
		roleMenuService.remove(Wrappers.<RoleMenu>update().lambda().in(RoleMenu::getRoleId, CollUtil.toList(ids)));
