...
import com.github.thundax.bacon.codegen.mapper.GenDatasourceConfMapper;
import com.github.thundax.bacon.codegen.service.GenDatasourceConfService;
import com.github.thundax.bacon.common.core.util.SpringContextHolder;
import com.github.thundax.bacon.common.datasource.util.DsConfTypeEnum;
import com.github.thundax.bacon.common.datasource.util.DsJdbcUrlEnum;
...
public class GenDatasourceConfServiceImpl extends ServiceImpl<GenDatasourceConfMapper, GenDatasourceConf>
	...
	public Boolean checkDataSource(GenDatasourceConf conf) {
		...
		try (Connection connection = DriverManager.getConnection(url, conf.getUsername(), conf.getPassword())) {
			log.info("数据源配置 {} , 获取链接成功", conf.getName());
		}
