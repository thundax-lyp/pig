package com.github.thundax.bacon.codegen.config;
...
@ConfigurationProperties(prefix = BaconCodeGenDefaultProperties.PREFIX)
public class BaconCodeGenDefaultProperties implements InitializingBean {
	 ...
	 * 生成代码的包名
	 */
	private String packageName = "com.github.thundax.bacon";
	 ...
	 * 生成代码的后端路径
	 */
	private String backendPath = "bacon";

	/**
	 * 生成代码的前端路径
	 */
	private String frontendPath = "bacon-ui";

	/**
	 * 生成代码的作者
	 */
	private String author = "bacon";
