...
public class DictResolver {
	...
	public String getDictItemLabel(String type, String itemValue) {
		...
		DictItemDTO sysDictItem = getDictItemByItemValue(type, itemValue);
	...
	public String getDictItemValue(String type, String itemLabel) {
		...
		DictItemDTO sysDictItem = getDictItemByItemLabel(type, itemLabel);
	 ...
	 * @return 字典数据项
	 */
	public DictItemDTO getDictItemByItemValue(String type, String itemValue) {
		Assert.isTrue(StrUtil.isNotBlank(type) && StrUtil.isNotBlank(itemValue), "参数不合法");

		List<DictItemDTO> dictItemList = getDictItemsByType(type);
	 ...
	 * @return 字典数据项
	 */
	public DictItemDTO getDictItemByItemLabel(String type, String itemLabel) {
		Assert.isTrue(StrUtil.isNotBlank(type) && StrUtil.isNotBlank(itemLabel), "参数不合法");
